...
async function selectGame(game) {
    ...
    if (workerPool.length === 0) {
        ...
        for (let i = 0; i < THREAD_COUNT; i++) {
            const wClassical = createClassicalWorker(); 
            wClassical.postMessage('uci');
            wClassical.postMessage('setoption name Use NNUE value false');
            ...
            workerPool.push({ classical: wClassical, deep: wDeep });
        }
    }
